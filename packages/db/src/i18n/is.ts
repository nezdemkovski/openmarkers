...
const is: TranslationData = {
  ui: {
    ...
    aiAnalysisDesc: "Afritaðu þessa kvaðningu með öllum rannsóknargögnum í hvaða gervigreindaraðstoðarmann sem er fyrir persónulega heilsugreiningu.",
    ...
    settingsChangeName: "Birtingarnafn",
    ...
    settingsMcpTools: "25 verkfæri í boði: listi yfir prófíla, þróun, lífaldur, fylgni, AI greiningar og fleira.",
