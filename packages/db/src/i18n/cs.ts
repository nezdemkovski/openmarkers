...
const cs: TranslationData = {
  ui: {
    ...
    aiAnalysisDesc: "Zkopírujte tento prompt se všemi laboratorními daty do libovolného AI asistenta pro personalizovanou zdravotní analýzu.",
    ...
    settingsChangeName: "Zobrazované jméno",
    ...
    settingsMcpTools: "25 dostupných nástrojů: seznam profilů, trendy, biologický věk, korelace, AI analýzy a další.",
