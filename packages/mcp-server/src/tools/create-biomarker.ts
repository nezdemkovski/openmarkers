  ...
  server.registerTool(
    "create_biomarker",
    {
      ...
      inputSchema: z.object({
        ...
        ref_min_m: z.number().optional().describe("Male reference range minimum"),
        ref_max_m: z.number().optional().describe("Male reference range maximum"),
        ref_min_f: z.number().optional().describe("Female reference range minimum"),
        ref_max_f: z.number().optional().describe("Female reference range maximum"),
