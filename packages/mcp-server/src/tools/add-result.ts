  ...
  server.registerTool(
    "add_result",
    {
      ...
      inputSchema: z.object({
        ...
        value: z
          ...
          .describe("Result value (numeric or string)"),
        ref_min: z
          .number()
          .nullish()
          .describe("Lab-reported reference minimum"),
        ref_max: z
          .number()
          .nullish()
          .describe("Lab-reported reference maximum"),
    ...
    async (input) => {
      try {
        ...
        return mcpError(
          e instanceof Error ? e.message : "Failed to add result",
        );
      }
    },
  );
