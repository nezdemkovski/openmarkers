        ...
        <div className="prose prose-sm dark:prose-invert max-w-none space-y-4 text-foreground/80">
          <section>
            ...
            <ul className="list-disc pl-5 space-y-1">
              ...
              <li>
                ...
                biomarker data, profile information (name, date of birth, sex)
                that you voluntarily enter
              </li>
              <li>
                <strong>Preferences</strong> — language and theme settings
                (stored in your browser only, not on our servers)
              </li>
            </ul>
            <p>
              We do <strong>not</strong> collect analytics, tracking data, IP
              addresses, or any data beyond what you explicitly provide.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-1">
              ...
              <li>
                Computing analytics (biological age, trend analysis,
                correlations) on our server
              </li>
              <li>
                Generating AI analysis prompts (the prompt is returned to you —
                we do not send it to any AI provider)
              </li>
            </ul>
            <p>
              We do <strong>not</strong> sell, share, or transfer your data to
              any third party.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              OpenMarkers provides an MCP endpoint that you can connect to AI
              assistants (Claude, ChatGPT, etc.). When you do this:
            </p>
            <ul className="list-disc pl-5 space-y-1">
              <li>
              ...
              <li>
                Once data reaches the AI provider, their privacy policy applies
                — we have no control over how they process it
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-1">
              ...
              <li>
                Authentication uses JWT tokens with RS256 signature verification
              </li>
              <li>
                All API endpoints require authentication — your data is never
          ...
          <section>
            ...
            <p>
              You can exercise these rights at any time from the Settings page:
            </p>
            <ul className="list-disc pl-5 space-y-1">
              <li>
              ...
              <li>
                <strong>Rectification</strong> — edit your results, profiles,
          ...
          <section>
            ...
            <p>
              Your data is stored as long as your account exists. When you
              delete your account, all profiles, biomarker data, and results are
