        ...
        <div className="prose prose-sm dark:prose-invert max-w-none space-y-4 text-foreground/80">
          <section>
            ...
            <ul className="list-disc pl-5 space-y-1">
              ...
              <li><strong>Health data</strong> — blood test results, lab values, biomarker data, profile information (name, date of birth, sex) that you voluntarily enter</li>
              <li><strong>Preferences</strong> — language and theme settings (stored in your browser only, not on our servers)</li>
            </ul>
            <p>We do <strong>not</strong> collect analytics, tracking data, IP addresses, or any data beyond what you explicitly provide.</p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-1">
              ...
              <li>Generating AI analysis prompts (the prompt is returned to you — we do not send it to any AI provider)</li>
            </ul>
            <p>We do <strong>not</strong> sell, share, or transfer your data to any third party.</p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-1">
              ...
              <li><strong>You</strong> initiate every data request — we never push data to AI providers</li>
              <li>Once data reaches the AI provider, their privacy policy applies — we have no control over how they process it</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-1">
              ...
              <li><strong>Rectification</strong> — edit your results, profiles, and account information</li>
