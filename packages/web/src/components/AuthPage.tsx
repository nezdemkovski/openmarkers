    ...
    <div className="min-h-screen bg-background flex flex-col relative overflow-hidden">
              ...
              {!ready ? (
                ...
                <div className="flex flex-col flex-1 min-h-0 animate-in fade-in duration-300">
                  <div className="flex items-center justify-between px-4 py-3 border-b border-border/60 dark:border-border/30 shrink-0">
                    ...
                    {profiles!.length > 0 && (
                      <a href="/profiles" className="text-[11px] text-muted-foreground/60 dark:text-muted-foreground/40 hover:text-muted-foreground transition-colors">{t("viewAll")}</a>
                    )}
                  </div>
                          ...
                          {profiles!.map((p, i) => (
                            <tr key={p.handle} className="group">
                              <td className="w-0 pl-4 pr-2 py-2.5">
                                <span className="text-[11px] text-muted-foreground/50 dark:text-muted-foreground/30 tabular-nums font-medium">{i + 1}</span>
                              </td>
                              ...
                              <td className="py-2.5 pr-4 text-right">
                                <a href={`/p/${p.handle}`} target="_blank" rel="noopener noreferrer" className="text-[11px] text-muted-foreground/55 dark:text-muted-foreground/35 font-mono group-hover:text-muted-foreground/80 dark:group-hover:text-muted-foreground/60 transition-colors">
                                  /p/{p.handle}
                                </a>
                              </td>
                            </tr>
      ...
      <footer className="border-t border-border/50 dark:border-border/20 py-4">
        <div className="max-w-5xl mx-auto px-5 flex items-center justify-between text-[11px] text-muted-foreground/60 dark:text-muted-foreground/40">
          <span>Built by <a href="https://github.com/nezdemkovski" target="_blank" rel="noopener noreferrer" className="hover:text-muted-foreground transition-colors">Yuri Nezdemkovski</a></span>
